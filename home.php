<?php 
    ...
    $nome_username = $_SESSION['user_username'];
    $iniziale_username = return_initial_username($nome_username);
    $id_utente = $_SESSION['user_id'];
    $email_utente = $_SESSION['user_email'];

    function return_initial_username($name)
    {
        if(!empty($name))
        {
        // elimino i caratteri '' spazio se ci sono
        $name_mod = str_replace(' ', '', $name);
        $initial = mb_substr($name_mod, 0, 1);
        return $initial;
    }else{
        echo "stringa vuota";
    }
...
<body>
    ...
    <section>
        ...
        <div class="welcome-box">
            ...
            <img src='immagini/image1.png' id="logo-fanta" />
            <h5> IL FANTASY GAME UFFICIALE DELLA SERIE A TIM </h5>
            <div class="gioca">
                <h4> Benvenuto <?php echo $nome_username ?> ! </h4>
            </div>
            <div class="flex-benvenuto">
                <div class="crealega">
                    <h6> VUOI DISCONNETTERTI DAL SITO? </h6>
                    <a href="logout.php" id="link3"> LOGOUT </a>
                </div>
        ...
        <div id="Menu">
            ...
            <div id="News">
                <h1>Ultime notizie del servizio GNEWS.IO</h1>
            </div>
            <div id="layout">
                <div id="sopracolore"></div>
                <form id="help">
                    <h3>Cerca la categoria di notizia di tuo interesse </h3>
                    <input type="text" placeholder="Inserisci l'argomento di tuo interesse..." id="notizia"
